...
### Upload Profiles
This project includes multiple upload profiles for easy deployment:

- **`controller`** - Upload to ESP32 with OLED + joysticks
- **`receiver`** - Upload to ESP32 receiver device

**VS Code Setup:**
1. Open Command Palette (`Ctrl+Shift+P`)
2. Select "PlatformIO: Select Environment"
3. Choose `controller` or `receiver`
4. Click upload button or use "PlatformIO: Upload"

See `UPLOAD_PROFILES.md` for detailed setup instructions.
